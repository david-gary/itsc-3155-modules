...
def scrape_book_titles(driver: webdriver.Chrome, url: str) -> list:
    ...
    # TODO 2: Use the driver to get the url

    # TODO 3: Get the list of books from the current page using the driver
    ...
    # TODO 4: Loop through the list of books and get the title of each book
